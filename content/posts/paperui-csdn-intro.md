...
以本博客（[newmo.tech](https://newmo.tech)）为例，构建产物体积如下：
...
- 在线 Demo：[newmo.tech](https://newmo.tech)
- 协议：MIT
...
- [PaperUI 配置参数说明](https://newmo.tech/posts/paperui-config-guide/)
- [Hugo 配置文件逐行详解](https://newmo.tech/posts/hugo-toml-config-guide/)
- [PaperMod 原项目](https://github.com/adityatelange/hugo-PaperMod)

---

*本文发布于 [newmo.tech](https://newmo.tech)。*
